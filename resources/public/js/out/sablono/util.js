...
var len__21393__auto___25443 = arguments.length;
var i__21394__auto___25444 = (0);
while(true){
if((i__21394__auto___25444 < len__21393__auto___25443)){
args__21400__auto__.push((arguments[i__21394__auto___25444]));

var G__25445 = (i__21394__auto___25444 + (1));
i__21394__auto___25444 = G__25445;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq25442){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25442));
});
...
var vec__25449 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__25451;
var words = seq__25450__$1;
...
var G__25453 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__25453,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__25453;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__25454_SHARP_){
if(typeof p1__25454_SHARP_ === 'string'){
return p1__25454_SHARP_;
} else {
return cljs.core.seq.call(null,p1__25454_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1483335399031