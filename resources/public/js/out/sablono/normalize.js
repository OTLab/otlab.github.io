...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__25457_SHARP_){
return ((p1__25457_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__25457_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__25459,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__25459;
}
});
...
var len__21393__auto___25462 = arguments.length;
var i__21394__auto___25463 = (0);
while(true){
if((i__21394__auto___25463 < len__21393__auto___25462)){
args__21400__auto__.push((arguments[i__21394__auto___25463]));

var G__25464 = (i__21394__auto___25463 + (1));
i__21394__auto___25463 = G__25464;
continue;
} else {
}
break;
...
var G__25461 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__25461,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__25461;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq25460){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25460));
});
...
var vec__25470 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__25470,(0),null);
var names = cljs.core.nth.call(null,vec__25470,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25470,tag_name,names){
return (function (p1__25465_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__25465_SHARP_));
});})(matches,vec__25470,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25470,tag_name,names){
return (function (p1__25466_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__25466_SHARP_));
});})(matches,vec__25470,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__25473){
var vec__25480 = p__25473;
...
var tag = first__25482;
var content = seq__25481__$1;
...
var vec__25483 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__25483,(0),null);
var id = cljs.core.nth.call(null,vec__25483,(1),null);
var class$ = cljs.core.nth.call(null,vec__25483,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1483335399210